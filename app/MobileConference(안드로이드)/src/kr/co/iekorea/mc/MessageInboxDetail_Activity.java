...
import kr.co.iekorea.mc.event.MessageInboxDetailEvent;
...
public class MessageInboxDetail_Activity extends Activity implements
		BaseInterface {
	// Activity control.
	...
	private TextView total_title,info_type,info_resiver,info_title,text_wait;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (StaticData.logined) {
			...
			new setMessageInBoxDetial(MessageInboxDetail_Activity.this).execute();
		} else {
	...
	public void onBackPressed() {
		Intent intent = new Intent(getApplicationContext(), MessageInbox_Activity.class);
		startActivity(intent);
		finish();
	}
	...
	public void initView() {
		this.setContentView(R.layout.activity_message_inbox_detail);
	...
	public void getXmlResources() {
		...
		this.btn_replay = (ImageButton) this.findViewById(R.id.btn_replay);
		...
		this.info_resiver = (TextView) this.findViewById(R.id.info_resiver);
		this.info_title = (TextView) this.findViewById(R.id.info_title);
		this.text_wait = (TextView) this.findViewById(R.id.text_wait);
	}
	
	public void setUpdateUI(){// 수신함
		this.text_user_name.setText(messageDetailDto.FROM_USER_NAME);
	...
	public void modifyXmlResources() {
		...
		case StaticData.KOREA:
			...
			this.btn_replay.setImageResource(R.drawable.b1_reply_kr);
			this.total_title.setText(R.string.inbox_ko);
			this.info_type.setText(R.string.type_ko);
			this.info_resiver.setText(R.string.recive_ko);
		...
		case StaticData.ENGLISH:
			...
			this.btn_replay.setImageResource(R.drawable.b1_reply_en);
			this.total_title.setText(R.string.inbox_en);
			this.info_type.setText(R.string.type_en);
			this.info_resiver.setText(R.string.recive_en);
		...
		case StaticData.CHINA:
			...
			this.btn_replay.setImageResource(R.drawable.b1_reply_cn);
			this.total_title.setText(R.string.inbox_cn);
			this.info_type.setText(R.string.type_cn);
			this.info_resiver.setText(R.string.recive_cn);
	...
	public void setEventListener() {
		this.btn_back.setOnClickListener(new MessageInboxDetailEvent(this,this));
		this.btn_replay.setOnClickListener(new MessageInboxDetailEvent(this,this,
				messageDetailDto.FROM_USER_NAME,messageDetailDto.MESSAGE_TYPE
				,messageDetailDto));
	}
	
	
	class setMessageInBoxDetial extends WeakAsyncTask<Void, Void, Void,Activity>{
		public setMessageInBoxDetial(Activity target) {
			super(target);
		...
		protected Void doInBackground(Activity target,Void... params) {
			MessageDAO dao = new MessageDAO(MessageInboxDetail_Activity.this);
			try {
